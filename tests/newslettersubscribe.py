...
if driver.find_element_by_class_name(newsletter_success).text == success_message:
    print(colored("Displayed message: " + driver.find_element_by_class_name(newsletter_success).text, "blue"))
else:
...
if driver.find_element_by_class_name(newsletter_failed).text == failed_message:
    print(colored("Displayed message: " + driver.find_element_by_class_name(newsletter_failed).text, "blue"))
else:
